...
test:
	...
	env ENVOY_PATH=$(BAZEL_OUTPUT_PATH)/k8-fastbuild/bin/src/envoy/envoy GO111MODULE=on go test ./...
...
test_asan:
	...
	env ENVOY_PATH=$(BAZEL_OUTPUT_PATH)/k8-opt/bin/src/envoy/envoy GO111MODULE=on go test ./...
