...
class DatasetJwk {
 public:
  ...
  const std::string kTokenECWrongKey =
      ...
      "xAZGV2ZWxvcGVyLmdzZXJ2aWNlYWNjb3VudC5jb20iLCJzdWIiOiI2Mjg2NDU3NDE4ODEtbm"
      "9h"
      "Y"
      "ml1MjNmNWE4bThvdmQ4dWN2Njk4bGo3OHZ2MGxAZGV2ZWxvcGVyLmdzZXJ2aWNlYWNjb3Vud"
      "C5"
      "j"
      "b20iLCJhdWQiOiJodHRwOi8vbXlzZXJ2aWNlLmNvbS9teWFwaSJ9."
      "s8J5UneA679P9jndvDoPjd"
      "L-mF7oyQsn7SPwfXVnudVLgca_GAEA7iQHBRj223joWNSFGT-VJ__EoHZb6R73Wg";

  const std::string kTokenECNoKid =
      "eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiI2M"
      "jg2NDU3NDE4ODEtbm9hYml1MjNmNWE4bThvdmQ4dWN2Njk4bGo3OHZ2MGxAZGV2ZWxvcGVyL"
      "md"
      "z"
      "ZXJ2aWNlYWNjb3VudC5jb20iLCJzdWIiOiI2Mjg2NDU3NDE4ODEtbm9hYml1MjNmNWE4bThv"
      "dm"
      "Q"
      "4dWN2Njk4bGo3OHZ2MGxAZGV2ZWxvcGVyLmdzZXJ2aWNlYWNjb3VudC5jb20iLCJhdWQiOiJ"
      "od"
      "H"
      "RwOi8vbXlzZXJ2aWNlLmNvbS9teWFwaSJ9.6vgyydZ_4xj_Vf-"
      "ZfMAlKwYcTAEnn5FDTlEDj61U"
