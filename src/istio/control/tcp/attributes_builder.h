...
class AttributesBuilder {
 public:
  AttributesBuilder(istio::mixer::v1::Attributes* attributes) : attributes_(attributes) {}

  // Extract attributes for Check.
  void ExtractCheckAttributes(CheckData* check_data);
  // Extract attributes for Report.
  void ExtractReportAttributes(const ::google::protobuf::util::Status& policy_check_status,
