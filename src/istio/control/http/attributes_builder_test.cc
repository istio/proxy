...
void ClearContextTime(const std::string &name, istio::mixer::v1::Attributes* attributes) {
...
void SetDestinationIp(istio::mixer::v1::Attributes* attributes, const std::string &ip) {
  utils::AttributesBuilder builder(attributes);
...
TEST(AttributesBuilderTest, TestReportAttributes) {
  ...
  istio::mixer::v1::Attributes attributes;
  AttributesBuilder builder(&attributes);
  builder.ExtractReportAttributes(::google::protobuf::util::Status::OK, &mock_data);
