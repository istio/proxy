...
// This is equivalent to the original mixer client logger, but is not used when mixer client is used
// inside Envoy.  This preserves mixer client's independence of the Envoy source code without forcing
// it to log (infrequenty) to stdout.
