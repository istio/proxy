...
ISTIO_API = "a11fc3a78b68ede57ad46fb4d1f7fe5742325489"
...
def authenticationapi_repositories(bind=True):
    BUILD = """
# Copyright 2018 Istio Authors. All Rights Reserved.
#
# Licensed under the Apache License, Version 2.0 (the "License");
...
"""
    ...
    if bind:
        native.bind(
            name = "authentication_policy_config_cc_proto",
            actual = "@authenticationapi_git//:authentication_policy_config_cc_proto",
        )
...
def  mixerapi_dependencies():
     ...
     authenticationapi_repositories()
