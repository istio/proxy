...
ENVOY_SHA = "d7092ec77cec8c09e3f512eeb99b79929d1187d2"

ENVOY_SHA256 = "db9238488a8ea26f7a75ac78f00a33d4d5eb3bf4dbef907ec2b71c1b368d3fe5"
...
http_archive(
    ...
    patches = [ "//patches:ep-stream-limits.patch"],
    patch_args = [ "-p1" ]
)
