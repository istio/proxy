...
// From
// https://github.com/istio/istio/blob/release-1.7/security/tools/jwt/samples/demo.jwt
...
// https://github.com/istio/istio/blob/release-1.7/security/tools/jwt/samples/README.md.
