...
var Runtimes = []struct {
	...
	{
		MetadataExchangeFilterCode: "filename: " + filepath.Join(env.GetBazelBin(), "extensions/metadata_exchange/plugin.wasm"),
		StatsFilterCode:            "filename: " + filepath.Join(env.GetBazelBin(), "extensions/stats/plugin.wasm"),
