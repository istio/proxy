...
struct FlatNode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<KeyVal>> *labels() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<KeyVal>> *>(VT_LABELS);
  }
  ...
  const flatbuffers::Vector<flatbuffers::Offset<KeyVal>> *platform_metadata() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<KeyVal>> *>(VT_PLATFORM_METADATA);
  }
...
struct FlatNodeBuilder {
  ...
  void add_labels(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<KeyVal>>> labels) {
  ...
  void add_platform_metadata(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<KeyVal>>> platform_metadata) {
...
inline flatbuffers::Offset<FlatNode> CreateFlatNode(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<KeyVal>>> labels = 0,
    flatbuffers::Offset<flatbuffers::String> app = 0,
    flatbuffers::Offset<flatbuffers::String> version = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<KeyVal>>> platform_metadata = 0,
...
inline flatbuffers::Offset<FlatNode> CreateFlatNodeDirect(
  ...
  auto labels__ = labels ? _fbb.CreateVector<flatbuffers::Offset<KeyVal>>(*labels) : 0;
  auto app__ = app ? _fbb.CreateString(app) : 0;
  auto version__ = version ? _fbb.CreateString(version) : 0;
  auto platform_metadata__ = platform_metadata ? _fbb.CreateVector<flatbuffers::Offset<KeyVal>>(*platform_metadata) : 0;
