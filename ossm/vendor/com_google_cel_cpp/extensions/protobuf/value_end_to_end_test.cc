...
struct TestCase {
  ...
  template <typename S>
  friend void AbslStringify(S& sink, const TestCase& tc) {
    sink.Append(tc.name);
  }
};

class ProtobufValueEndToEndTest : public TestWithParam<TestCase> {
 public:
  ProtobufValueEndToEndTest() = default;

 protected:
  const TestCase& test_case() const { return GetParam(); }
...
TEST_P(ProtobufValueEndToEndTest, Runner) {
  ...
  ASSERT_OK_AND_ASSIGN(Value result, program->Evaluate(&arena_, activation));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(std::vector<TestCase>{
        ...
        {"wkt_int64", "msg.single_int64_wrapper",
         ...
         IntValueIs(-20)},
        {"wkt_int64_default", "msg.single_int64_wrapper", "", IsNullValue()},
        {"wkt_int32", "msg.single_int32_wrapper",
         R"pb(
           single_int32_wrapper { value: -10 }
         )pb",
         IntValueIs(-10)},
        {"wkt_int32_default", "msg.single_int32_wrapper", "", IsNullValue()},
        {"wkt_uint64", "msg.single_uint64_wrapper",
         R"pb(
           single_uint64_wrapper { value: 10 }
         )pb",
         UintValueIs(10)},
        {"wkt_uint64_default", "msg.single_uint64_wrapper", "", IsNullValue()},
        {"wkt_uint32", "msg.single_uint32_wrapper",
         R"pb(
           single_uint32_wrapper { value: 11 }
         )pb",
         UintValueIs(11)},
        {"wkt_uint32_default", "msg.single_uint32_wrapper", "", IsNullValue()},
        {"wkt_float", "msg.single_float_wrapper",
         R"pb(
           single_float_wrapper { value: 10.25 }
         )pb",
         DoubleValueIs(10.25)},
        {"wkt_float_default", "msg.single_float_wrapper", "", IsNullValue()},
        {"wkt_double", "msg.single_double_wrapper",
         R"pb(
           single_double_wrapper { value: 10.25 }
         )pb",
         DoubleValueIs(10.25)},
        {"wkt_double_default", "msg.single_double_wrapper", "", IsNullValue()},
        ...
        {"wkt_string", "msg.single_string_wrapper",
         ...
         StringValueIs("abcd")},
        {"wkt_string_default", "msg.single_string_wrapper", "", IsNullValue()},
        {"wkt_bytes", "msg.single_bytes_wrapper",
         R"pb(
           single_bytes_wrapper { value: "abcd" }
         )pb",
         BytesValueIs("abcd")},
        {"wkt_bytes_default", "msg.single_bytes_wrapper", "", IsNullValue()},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(std::vector<TestCase>{
        ...
        {"single_any_wkt_double", "msg.single_any",
         R"pb(
           single_any {
             [type.googleapis.com/google.protobuf.DoubleValue] { value: 30.5 }
           }
         )pb",
         DoubleValueIs(30.5)},
        {"single_any_wkt_string", "msg.single_any",
         R"pb(
           single_any {
             [type.googleapis.com/google.protobuf.StringValue] { value: "abcd" }
           }
         )pb",
         StringValueIs("abcd")},
