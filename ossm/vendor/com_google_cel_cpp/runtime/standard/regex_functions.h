...
// Register builtin regex functions:
//
// (string).matches(re:string) -> bool
// matches(string, re:string) -> bool
//
// These are implemented with RE2.
//
...
#endif  // THIRD_PARTY_CEL_CPP_RUNTIME_STANDARD_REGEX_FUNCTIONS_H_
