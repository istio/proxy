# Contributing to hessian2-codec

Welcome to hessian2-codec! This document is a guideline about how to contribute to hessian2-codec.
...
We use [GitHub Issues](https://github.com/alibaba/hessian2-codec/issues) and [Pull Requests](https://github.com/alibaba/hessian2-codec/pulls) for trackers.

If you find a typo in document, find a bug in code, or want new features, or want to give suggestions,
you can [open an issue on GitHub](https://github.com/alibaba/hessian2-codec/issues/new) to report it.
