...
visionos_test_runner = rule(
    _visionos_test_runner_impl,
    attrs = {
        "device_type": attr.string(
            default = "",
            doc = """
The device type of the visionOS simulator to run test. The supported types correspond
to the output of `xcrun simctl list devicetypes`. E.g., "Apple Vision Pro".
By default, it is the latest supported type.'
""",
        ),
...
""",
        ...
        "_test_template": attr.label(
            default = Label(
                "//apple/testing/default_runner:visionos_test_runner.template.sh",
            ),
...
""",
    ...
    doc = """
Rule to identify a visionOS runner that runs tests for visionOS.
