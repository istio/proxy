...
#include "google/protobuf/util/converter/mock_error_listener.h"
...
#include "google/protobuf/util/converter/testdata/anys.pb.h"
#include "google/protobuf/util/converter/testdata/books.pb.h"
#include "google/protobuf/util/converter/testdata/field_mask.pb.h"
#include "google/protobuf/util/converter/testdata/maps.pb.h"
#include "google/protobuf/util/converter/testdata/oneofs.pb.h"
#include "google/protobuf/util/converter/testdata/proto3.pb.h"
#include "google/protobuf/util/converter/testdata/struct.pb.h"
#include "google/protobuf/util/converter/testdata/timestamp_duration.pb.h"
#include "google/protobuf/util/converter/testdata/wrappers.pb.h"
...
std::string GetTypeUrl(const Descriptor* descriptor) {
  return absl::StrCat(kTypeServiceBaseUrl, "/", descriptor->full_name());
}
}  // namespace
...
class BaseProtoStreamObjectWriterTest
 ...
 protected:
  ...
  void ResetTypeInfo(std::vector<const Descriptor*> descriptors) {
    ABSL_QCHECK(!descriptors.empty()) << "Must have at least one descriptor!";
...
TEST_P(ProtoStreamObjectWriterMapTest, MapAcceptsNullValue) {
  ...
  // See internal-link-go/proto3-json-spec#heading=h.r2ddatp7y4vi
