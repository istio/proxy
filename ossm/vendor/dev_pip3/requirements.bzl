...
_config = {
    ...
    "quiet": True,
    "repo": "dev_pip3",
    "repo_prefix": "dev_pip3_",
    "timeout": 600,
}
_annotations = {}

def requirement(name):
    return "@dev_pip3//{}:{}".format(pip_utils.normalize_name(name), "pkg")

def whl_requirement(name):
    return "@dev_pip3//{}:{}".format(pip_utils.normalize_name(name), "whl")

def data_requirement(name):
    return "@dev_pip3//{}:{}".format(pip_utils.normalize_name(name), "data")

def dist_info_requirement(name):
    return "@dev_pip3//{}:{}".format(pip_utils.normalize_name(name), "dist_info")
...
def install_deps(**whl_library_kwargs):
    ...
    config_repo = "dev_pip3__config"
    whl_config_repo(
        name = "dev_pip3__config",
        repo_prefix = "dev_pip3_",
    ...
    for name, requirement in _packages:
        group_name = requirement_group_mapping.get(name.replace("dev_pip3_", ""))
