...
type OpenRcaServiceClient interface {
	StreamCoreMetrics(ctx context.Context, in *OrcaLoadReportRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.OrcaLoadReport], error)
}
...
func (c *openRcaServiceClient) StreamCoreMetrics(ctx context.Context, in *OrcaLoadReportRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.OrcaLoadReport], error) {
	...
	x := &grpc.GenericClientStream[OrcaLoadReportRequest, v1.OrcaLoadReport]{ClientStream: stream}
...
type OpenRcaService_StreamCoreMetricsClient = grpc.ServerStreamingClient[v1.OrcaLoadReport]
...
type OpenRcaServiceServer interface {
	StreamCoreMetrics(*OrcaLoadReportRequest, grpc.ServerStreamingServer[v1.OrcaLoadReport]) error
}
...
func (UnimplementedOpenRcaServiceServer) StreamCoreMetrics(*OrcaLoadReportRequest, grpc.ServerStreamingServer[v1.OrcaLoadReport]) error {
...
func _OpenRcaService_StreamCoreMetrics_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(OpenRcaServiceServer).StreamCoreMetrics(m, &grpc.GenericServerStream[OrcaLoadReportRequest, v1.OrcaLoadReport]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type OpenRcaService_StreamCoreMetricsServer = grpc.ServerStreamingServer[v1.OrcaLoadReport]
