...
class Struct_FieldsEntry_DoNotUse : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntryLite<Struct_FieldsEntry_DoNotUse, 
    std::string, ::google::protobuf::Value,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_MESSAGE,
    0 > {
public:
  typedef ::PROTOBUF_NAMESPACE_ID::internal::MapEntryLite<Struct_FieldsEntry_DoNotUse, 
    std::string, ::google::protobuf::Value,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_MESSAGE,
    0 > SuperType;
...
class Struct :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:google.protobuf.Struct) */ {
 public:
  Struct();
  virtual ~Struct();
  ...
  void clear_fields();
  const ::PROTOBUF_NAMESPACE_ID::Map< std::string, ::google::protobuf::Value >&
      fields() const;
...
class Value :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:google.protobuf.Value) */ {
 public:
  Value();
  virtual ~Value();
...
class ListValue :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:google.protobuf.ListValue) */ {
 public:
  ListValue();
  virtual ~ListValue();
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::protobuf::Value >*
      mutable_values();
  const ::google::protobuf::Value& values(int index) const;
  ::google::protobuf::Value* add_values();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::protobuf::Value >&
      values() const;
...
inline void Value::set_string_value(const std::string& value) {
  ...
  kind_.string_value_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value,
      GetArenaNoVirtual());
