# Generated by /scripts/vendor_npm.sh
...
# Vendored on Mon 12 Aug 2019 15:32:04 CDT from npm with /scripts/vendor_npm.sh
...
# shell commands:
# third_party/node_modules/.bin/ncc build third_party/node_modules/browserify/bin/cmd.js -o third_party/npm/node_modules/browserify
# sedi s#parent.id !== self._mdeps.top.id#parent.id# third_party/npm/node_modules/browserify/index.js
# sedi s#require('process/browser.js')#require('./browser1')# third_party/npm/node_modules/browserify/main.js
# mv third_party/npm/node_modules/browserify/index.js third_party/npm/node_modules/browserify/index.debug.js
# third_party/node_modules/.bin/terser --compress --mangle --comments /(^!|@license|@preserve|Copyright)/ -- third_party/npm/node_modules/browserify/index.debug.js
# cp -f third_party/node_modules/browserify/LICENSE third_party/npm/node_modules/browserify

# package.json (SHA256 a38781b0335f876a95f3c7425eb6156166d507a11578381997f09974ffc8d44c):
# {
#   "private": true,
#   "devDependencies": {
#       "@babel/core": "7.5.5",
...
# yarn.lock (SHA256 5ffe39f05b0c42fe992fe7a0026b54146a4bb6f64bf6a0c3977d0f30c7e0ffb0):
...
# named-amd@1.0.0:
#   version "1.0.0"
#   resolved "https://registry.yarnpkg.com/named-amd/-/named-amd-1.0.0.tgz#37fd4ef2568afbf6bd61250c7de56df028502572"
#   integrity sha1-N/1O8laK+/a9YSUMfeVt8ChQJXI=
#
# object-assign@^4.1.1:
#   version "4.1.1"
