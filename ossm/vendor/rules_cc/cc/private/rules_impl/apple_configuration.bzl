...
load(":apple_platform.bzl", "PLATFORM_TYPE", "apple_platform")
...
# LINT.ThenChange(https://github.com/bazelbuild/bazel/blob/master/src/main/java/com/google/devtools/build/lib/rules/apple/AppleConfiguration.java)
