...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "serde": Label("@t3p__serde-1.0.215//:serde"),
            "serde_json": Label("@t3p__serde_json-1.0.133//:serde_json"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("//test/3rdparty/crates:BUILD.itoa-1.0.14.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/3rdparty/crates:BUILD.memchr-2.7.4.bazel"),
    )

    maybe(
        http_archive,
        name = "t3p__proc-macro2-1.0.92",
        ...
        build_file = Label("//test/3rdparty/crates:BUILD.proc-macro2-1.0.92.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/3rdparty/crates:BUILD.quote-1.0.37.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/3rdparty/crates:BUILD.ryu-1.0.18.bazel"),
    )

    maybe(
        http_archive,
        name = "t3p__serde-1.0.215",
        ...
        build_file = Label("//test/3rdparty/crates:BUILD.serde-1.0.215.bazel"),
    )

    maybe(
        http_archive,
        name = "t3p__serde_derive-1.0.215",
        ...
        build_file = Label("//test/3rdparty/crates:BUILD.serde_derive-1.0.215.bazel"),
    )

    maybe(
        http_archive,
        name = "t3p__serde_json-1.0.133",
        ...
        build_file = Label("//test/3rdparty/crates:BUILD.serde_json-1.0.133.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/3rdparty/crates:BUILD.syn-2.0.90.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//test/3rdparty/crates:BUILD.unicode-ident-1.0.14.bazel"),
    )

    return [
        struct(repo = "t3p__serde-1.0.215", is_dev_dep = False),
        struct(repo = "t3p__serde_json-1.0.133", is_dev_dep = False),
    ]
