...
TypeHelper::TypeHelper(pbutil::TypeResolver* type_resolver) :
  type_resolver_(type_resolver), type_info_(pbconv::TypeInfo::NewTypeInfo(type_resolver)) {}
...
void TypeHelper::AddType(const pb::Type& t) { reinterpret_cast<SimpleTypeResolver *>(type_resolver_)->AddType(t); }

void TypeHelper::AddEnum(const pb::Enum& e) { reinterpret_cast<SimpleTypeResolver *>(type_resolver_)->AddEnum(e); }
