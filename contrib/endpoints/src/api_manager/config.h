...
class Config {
 ...
 private:
  ...
  bool LoadHttpMethods(ApiManagerEnvInterface *env, PathMatcherBuilder<MethodInfo*> *pmb);
  ...
  bool LoadRpcMethods(ApiManagerEnvInterface *env, PathMatcherBuilder<MethodInfo*> *pmb);
