...
class CheckDisableSecurityRulesTest
 ...
 public:
  void SetUp() {
    std::unique_ptr<MyMockApiManagerEnvironment> env(
        new ::testing::NiceMock<MyMockApiManagerEnvironment>());
    MyMockApiManagerEnvironment *raw_env = env.get();
...
class CheckSecurityRulesTest : public ::testing::Test {
 public:
  ...
  MyMockApiManagerEnvironment *raw_env_;
